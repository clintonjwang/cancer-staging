...
def dicom_series_to_nifti(original_dicom_directory, output_file, reorient_nifti=False):
	...
	import importlib
	importlib.reload(convert_generic)
	importlib.reload(convert_siemens)
...
def are_imaging_dicoms(dicom_input):
	...
	return True#Tag(0x0020, 0x0037) in header
